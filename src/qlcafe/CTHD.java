...
public class CTHD extends javax.swing.JFrame {
    ...
    CTHoa_DON hdselected;

    public CTHD() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Chi tiết hóa đơn");
        dtmHD = (DefaultTableModel) this.tblCT.getModel();
        ketNoiCSDL();
        hienThiDSHD();
    }
     ...
     public boolean kiemTraMaSoTonTai(String maso) {
        try {
            String sqlSelect = "SELECT * FROM CHITIETHOADON WHERE  = '" + maso + "'";
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Chi tiết", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18), new java.awt.Color(255, 102, 51))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        jLabel2.setText("MACTHD");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtDG, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                    .addComponent(txtCT)
                    .addComponent(txtTen)
                    .addComponent(txtSL)
                    .addComponent(txtGG))
        ...
        tblCT.setBackground(new java.awt.Color(153, 255, 204));
        tblCT.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã chi tiết", "Tên sản phẩm", "Số lượng", "Giảm giá", "Đơn giá"
            }
        ));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/floppy-disk (1).png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtF, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblCTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTMouseClicked
        // TODO add your handling code here:
        int rowSelected = this.tblCT.getSelectedRow();
         txtCT.setText((String) tblCT.getValueAt(rowSelected, 0));
        txtTen.setText((String) tblCT.getValueAt(rowSelected, 1));
        txtSL.setText((String) tblCT.getValueAt(rowSelected, 2));
        txtGG.setText((String) tblCT.getValueAt(rowSelected, 3));
        txtDG.setText((String) tblCT.getValueAt(rowSelected, 4));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "SELECT * FROM CHITIETHOADON WHERE MACTHD like N'"+txtF.getText()+"%'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
           if (kiemTraMaSoTonTai(txtCT.getText()) == true) {
            ...
            if (tl == JOptionPane.NO_OPTION) {
                ...
                try {
                    String sqlUpdate = "UPDATE CHITIETHOADON SET TENsanpham = N'"
                    + txtTen.getText() + "', SOLUONG= " + txtSL.getText() + ",GIAMGIA= " + txtGG.getText() + ",DONGIA= " + txtDG.getText() + " WHERE MACTHD = '"
                    + txtCT.getText() + "'";
        ...
        {
            try {
                String sqlInsert = " INSERT INTO CHITIETHOADON(TENSANPHAM,SOLUONG,GIAMGIA)  VALUES(N'" + txtTen.getText() + "',"
                + txtSL.getText() + ", " + txtGG.getText() + ")";
